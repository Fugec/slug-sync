...
| `icon-128x128.png` | Plugin icon, standard resolution. |
| `icon-256x256.png` | Plugin icon, high resolution. |
...
SVG here. Both icons are well under the 1 MB per-icon limit. The 128x128 and
772x250 standard sizes are downscaled from the supplied 256x256 icon and
1544x500 banner rather than supplied separately.
